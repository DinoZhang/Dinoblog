...
$youzhuti_update_checker=new ThemeUpdateChecker('风影博客主题','http://www.youzhuti.com/fengying_blog_theme/info.json');
...
function custom_excerpt_length($length){return 240;}
